...
error=1
: "${TREZOR_MONERO_TESTS_URL:=https://github.com/ph4r05/monero/releases/download/v0.18.3.1-dev-tests-u20.04-02/trezor_tests}"
: "${TREZOR_MONERO_TESTS_SHA256SUM:=f10d0d7c9da072a3779b94eee866b92e1c458e79ce078b1df6b42ee7101c3227}"
