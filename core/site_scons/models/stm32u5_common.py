...
def stm32u5_common_files(env, defines, sources, paths):
    ...
    paths += [
        ...
        "embed/utl/board_capabilities/inc",
        "embed/utl/flash/inc",
        "embed/utl/fwutils/inc",
        "embed/utl/option_bytes/inc",
        "embed/utl/unit_properties/inc",
    ...
    sources += [
        ...
        "embed/utl/board_capabilities/stm32/board_capabilities.c",
        "embed/utl/flash/stm32u5/flash.c",
        "embed/utl/flash/stm32u5/flash_layout.c",
        "embed/utl/flash/stm32u5/flash_otp.c",
        "embed/utl/fwutils/fwutils.c",
        "embed/utl/option_bytes/stm32u5/option_bytes.c",
        "embed/utl/unit_properties/stm32/unit_properties.c",
    ]
